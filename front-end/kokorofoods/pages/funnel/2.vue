  ...
  <main role="main">
    <section class="container col-md-12 section" v-if="!mobile">
      ...
      <div class="headcontent mx-auto">
        <p class="head1 text-center text-uppercase mb-0 py-0">Aprovecha el despacho
        <span class="head1span">gratis.</span></p>
        <p class="head2 text-center text-uppercase mt-0 py-0 mb-0">Agregando una pasta de ajo negro</p>
      </div>
    </section>
    <section class="container col-md-12 section" v-if="!mobile">
      <div class="row p-0">
      ...
      <div class="mb-4">
        <p class="right1">Disfruta este ajo negro con un recetario que te ayudara a sorprender amigos y familiares.</p>
        <h4 class="right2">Que llevarías:</h4>
        <span><ul>
          <li><span class="right3">140gr de Ajo Negro </span>puro $6.500.</li>
          <li><span class="right4">100% Ajo Negro </span>sin conservantes.</li>
          <li>Producido con Ajo cultivado en <span class="right5">Chile.</span> </li>
          <li>Listo para usar, no necesita cocción.</li>
          <li>Recetario <span class="right6">Exclusivo</span> Kokorofoods Valor $3.000</li>
        </ul></span>
        </div>
          <div class="right7">
            <p class="right8"><del> Antes: $9.500 </del></p>
            <p class="right9">$23.500</p>
            <p class="right10" style="font-size: 16px; font-weight: 700">+ despacho ($4.000)</p>
          </div>
        </div>
...
.head2 {
  font-size: 3rem; font-weight: smaller;
}
